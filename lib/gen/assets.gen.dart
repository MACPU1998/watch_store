...
class $AssetsPngGen {
  ...
  /// File path: assets/png/logo_watch.png
  AssetGenImage get logoWatch =>
      const AssetGenImage('assets/png/logo_watch.png');

  /// File path: assets/png/unnamed.png
  AssetGenImage get unnamed => const AssetGenImage('assets/png/unnamed.png');

  /// List of all assets
  List<AssetGenImage> get values => [avatar, logoWatch, unnamed];
}
